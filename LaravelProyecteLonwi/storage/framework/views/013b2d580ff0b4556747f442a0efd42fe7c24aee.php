    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li<?php echo e(Request::is('CTier*') && !Request::is('CTier/create')? ' class=active' : ''); ?>>
                    <a href="<?php echo e(url('/CTier')); ?>">
                        <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
                        Tier
                    </a>
                </li>
                <li<?php echo e(Request::is('CTier/create') ? ' class=active' : ''); ?>>
                    <a href="<?php echo e(url('/CTier/create')); ?>">
                        <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
                        Nuevo Tier
                    </a>
                </li>
